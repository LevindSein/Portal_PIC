    ...
    public function listrik(){
        if(request()->ajax()){
            ...
            ->addColumn('action', function($data){
                ...
                $button .= '&nbsp;&nbsp;<a type="button" data-toggle="tooltip" title="Delete Permanent" name="delete" id="'.$data->id.'" nama="'.substr($data->name,0,15).'" class="delete"><i class="fas fa-trash-alt" style="color:#e74a3b;"></i></a>';
