            ...
            <table class="tg">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tg-g25h" style="text-align: left;">{{$d->name}}</td>
                        <td class="tg-g25h" style="text-align: right;">{{($d->data) ? count(json_decode($d->data)) : 0}}</td>
                        <td class="tg-g25h" style="text-align: left; white-space: normal;">{{($d->data) ? implode(', ', json_decode($d->data))  : ''}}</td>
                    </tr>
                    @php
                        $i++;
                    @endphp
