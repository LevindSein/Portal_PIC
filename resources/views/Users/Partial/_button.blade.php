...
<div class="dropdown-menu dropdown-menu-right">
    <a class="dropdown-item" id="add" href="javascript:void(0)"><i class="fas fa-fw fa-plus"></i>Tambah</a>
    ...
    <a class="dropdown-item" id="deleted" href="javascript:void(0)"><i class="fas fa-fw fa-trash"></i>Data Pengguna Terhapus</a>
</div>
