                                ...
                                <div id="divlistrik" style="padding-left: 2rem;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input maxlength="3" type="text" id="dayalistrik" name="dayalistrik" autocomplete="off" placeholder="Ketikkan dalam angka" class="number percent form-control form-control-line">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input maxlength="11" type="text" id="awlistrik" name="awlistrik" autocomplete="off" placeholder="Ketikkan dalam angka" class="number percent form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Akhir Meter <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input maxlength="11" type="text" id="aklistrik" name="aklistrik" autocomplete="off" placeholder="Ketikkan dalam angka" class="number percent form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Diskon</label>
                            ...
                            <div>
                                ...
                                <div id="divairbersih" style="padding-left: 2rem;">
                                    ...
                                    <div class="form-group">
                                        <label>Awal Meter <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input maxlength="11" type="text" id="awairbersih" name="awairbersih" autocomplete="off" placeholder="Ketikkan dalam angka" class="number percent form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Akhir Meter <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input maxlength="11" type="text" id="akairbersih" name="akairbersih" autocomplete="off" placeholder="Ketikkan dalam angka" class="number percent form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Diskon</label>
...
<script>
    $(document).ready(function(){
        ...
        function initForm(){
            ...
            $("#group").prop("disabled", true).val("").html("");
            $("#group").select2({
                placeholder: "(Sesuai Kode Kontrol yang terisi)"
            });
