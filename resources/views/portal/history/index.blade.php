...
<script>
    var dtable = $('#dtable').DataTable({
        ...
        "columns": [
            ...
            { data: 'status', name: 'status', class : 'text-center align-middle' },
            { data: { '_': 'created_at.display', 'sort': 'created_at.timestamp' }, name: 'created_at', class : 'text-center align-middle'  },
