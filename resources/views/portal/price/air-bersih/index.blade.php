                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xlg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input maxlength="3" required type="text" id="airkotor" name="airkotor" autocomplete="off" placeholder="Ketikkan dalam angka 0-100" class="percent form-control form-control-line">
                                    <div class="input-group-prepend">
